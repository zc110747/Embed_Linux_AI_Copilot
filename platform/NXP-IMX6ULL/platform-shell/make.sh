...
KERNEL_PATH="${AI_SDK_SOC_PATH}/kernel"
ROOTFS_PATH="${AI_SDK_SOC_PATH}/rootfs"
PACKAGE_PATH="${AI_SDK_SOC_PATH}/package"
ROOTFS_SHELL_PATH="${AI_PLATFORM_SOC_PATH}/platform-shell"
